  ...
  "children" : [ {
    ...
    "allowedValues" : {
      ...
      },
      {
        ...
        "value" : "TEMPLATE_INVALID"
      }, {
        "label" : "UPLOAD_IN_PROGRESS",
        "value" : "UPLOAD_IN_PROGRESS"
      },
      {
        "label" : "UPLOAD_ACTIVITY_CREATED",
        "value" : "UPLOAD_ACTIVITY_CREATED"
      }, {
        "label" : "STOP_EXECUTION",
        "value" : "STOP_EXECUTION"
      }, {
        "label" : "UPLOAD_SUCCESS_WITH_ERRORS",
        "value" : "UPLOAD_SUCCESS_WITH_ERRORS"
      },
      {
        "label" : "UPLOAD_SUCCESS",
        "value" : "UPLOAD_SUCCESS"
      }, {
        "label" : "UPLOAD_FAILURE",
      ...
      "conditions" : {
        ...
        "conditions" : [ 
          ...
          "id" : "VALIDATION_TASK_CREATED",
          "query" : {
            "condition" : "and",
            "rules" : [ {
              "field" : "dropdown1",
              "operator" : "==",
              "value" : "Validation task created"
            } ]
          },
          "style" : {
            "background-color" : "#1A73E833",
        ...
        {
          "id" : "VALIDATION_IS_IN_PROGRESS",
          "query" : {
            "condition" : "and",
            "rules" : [ {
              "field" : "dropdown1",
              "operator" : "==",
              "value" : "Validation is inprogress"
            } ]
          },
          "style" : {
            "background-color" : "#1A73E833",
        ...
        {
          "id" : "UPLOAD_IN_PROGRESS",
          "query" : {
            "condition" : "and",
            "rules" : [ {
              "field" : "dropdown1",
              "operator" : "==",
              "value" : "Upload inprogress"
            } ]
          },
          "style" : {
            "background-color" : "#1A73E833",
        ...
        {
          "id" : "UPLOAD_ACTIVITY_CREATED",
          "query" : {
            "condition" : "and",
            "rules" : [ {
              "field" : "dropdown1",
              "operator" : "==",
              "value" : "Upload activity created"
            } ]
          },
          "style" : {
            "background-color" : "#1A73E833",
        ...
        {
          "id" : "UPLOAD_SUCCESS_WITH_ERRORS",
          "query" : {
            "condition" : "and",
            "rules" : [ {
              "field" : "dropdown1",
              "operator" : "==",
              "value" : "Upload success with errors"
            } ]
          },
          "style" : {
...
onImportSucess(){
  ...
  this.clearFilterValues();
    ...
    let action: Exclude<keyof ImportHistoryComponent, ' '> = methodName;
...
getParentId() {
  ...
  let property: Exclude<keyof ImportHistoryComponent, ' '> = value;
  if (this.isChildPage) {
    if (this[property]) {
