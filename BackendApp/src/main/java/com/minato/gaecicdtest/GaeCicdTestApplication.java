package com.minato.gaecicdtest;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minato.gaecicdtest"})
@EnableCaching
...
public class GaeCicdTestApplication {

	public static void main(String[] args) {
		SpringApplication.run(GaeCicdTestApplication.class, args);
	}
